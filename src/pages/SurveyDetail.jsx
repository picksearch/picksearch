  ...
  */
  ...
  const { data: allResponses = [], isLoading: responsesLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const rs = await Response.filter({ survey_id: surveyId }, '-created_date', 5000);
      return rs;
    },
    enabled: !!surveyId,
    staleTime: 60000,
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <Badge className={
                        ...
                        question.question_type === 'phone_number' ? 'bg-emerald-100 text-emerald-700 border-0' :
                        ...
                        {question.question_type === 'multiple_choice' ? '객관식' : 
                         ...
                         question.question_type === 'phone_number' ? '전화번호' :
                        ...
                        getAnswersByQuestion(question.id).map((answer, idx) => (
                          <div key={idx} className="bg-emerald-50 rounded-xl p-3">
                            <div className="flex items-center gap-2">
                              ...
                              <p className="text-sm text-gray-800 font-mono font-bold">{answer}</p>
                            </div>
                          </div>
                        ))
                      )}
