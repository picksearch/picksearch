...
import { Survey, CreditTransaction, SystemConfig } from "@/api/entities";
  ...
  const submitPaymentInfoMutation = useMutation({
    mutationFn: async () => {
      ...
      await CreditTransaction.create({
        ...
        status: 'pending',
        survey_id: surveyId,
        description: `${survey.title} - 입금 대기`,
        ...
        <Card className="bg-white rounded-3xl shadow-sm border border-gray-100">
          ...
          <CardContent className="p-6 space-y-4">
            ...
            <div className="space-y-3">
              ...
              proofType === 'cash_receipt_personal' ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 border-gray-200'}`
              }>
              ...
              <label className={`flex items-center justify-between p-4 rounded-xl border-2 cursor-pointer transition-all ${
              proofType === 'cash_receipt_business' ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 border-gray-200'}`
              }>
                <div className="flex items-center gap-3">
                  <input
                    type="radio"
              ...
              <label className={`flex items-center justify-between p-4 rounded-xl border-2 cursor-pointer transition-all ${
              proofType === 'tax_invoice' ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 border-gray-200'}`
              }>
                <div className="flex items-center gap-3">
                  <input
                    type="radio"
            ...
            <div className="space-y-2 pt-2">
                ...
                onChange={(e) => setProofIdentifier(e.target.value)}
