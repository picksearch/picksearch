...
import { User, Mail, Shield, LogOut, Save, Settings, Gift, Coins, History, ChevronRight, ShoppingBag, Copy, Check } from "lucide-react";
...
export default function MyPage() {
  ...
  const getTransactionTypeLabel = (type) => {
    switch (type) {
      case 'referral_bonus': return '추천 보상';
      case 'referred_bonus': return '가입 보너스';
      case 'monthly_bonus': return '월간 보너스';
