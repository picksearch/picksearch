...
export default function APIGuide() {
  ...
  -d '{
    ...
    "survey_purpose": "타겟 고객의 화장품 구매 패턴 분석",
    "usage_purpose": "신제품 출시 전략 수립",
    "questions": [
      {
  ...
  -d '{
    ...
    "title": "수정된 제목",
    "description": "수정된 설명",
    "scheduled_end": "2025-02-28"
  }'`,
      response: `{
  "success": true,
  "survey_id": "abc123",
  "updated_fields": ["title", "description", "scheduled_end"]
}`
    },
    {
      title: "4. 질문 추가",
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-gray-600">
              <code className="bg-gray-100 px-2 py-1 rounded">target_options</code> 객체 구조:
            </p>
            <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-xs">
{`{
  "cells": [{
